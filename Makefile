...
LD_FLAGS  = \
	-X axone-protocol/jackal-auth-proxy/internal/version.Name=$(BINARY_NAME) \
	-X axone-protocol/jackal-auth-proxy/internal/version.Version=$(VERSION)  \
	-X axone-protocol/jackal-auth-proxy/internal/version.Commit=$(COMMIT)
